"""Approximate quantiles of few-shot prototypical networks for mini imagenet."""
...
class QuantileProto(pytorch_lightning.LightningModule):

    def __init__(self, hparams):
        super(QuantileProto, self).__init__()
...
def main(args):
    ...
    model = QuantileProto(hparams=args)
...
if __name__ == "__main__":
    ...
    parser = QuantileProto.add_model_specific_args(parser)
